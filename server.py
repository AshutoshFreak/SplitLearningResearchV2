...
def main(server_pipe_endpoints, args):
    ...
    num_iterations, num_test_iterations, random_connected_clients = get_object(first_client.conn)
    ...
    for _ in random_connected_clients:
        random_client_id = get_object(first_client.conn)
        random_client = random_connected_clients[random_client_id]
